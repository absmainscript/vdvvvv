      ...
      <div className="container mx-auto mobile-container max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-block mb-4">
            <span className={`text-sm font-medium ${processBadgeWithGradient('', badgeGradient)} px-4 py-2 rounded-full`}>
          ...
          <h2 className="font-display font-medium text-2xl sm:text-3xl md:text-4xl text-gray-900 mb-6 tracking-tight">
            {processTextWithGradient(photoCarouselConfig.title || "Galeria", badgeGradient)}
          </h2>
