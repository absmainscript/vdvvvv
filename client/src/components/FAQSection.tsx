...
import { processTextWithGradient, processBadgeWithGradient } from "@/utils/textGradient"; // Processa texto com gradiente
      ...
      <div className="py-8 sm:py-12">
        <div className="container mx-auto max-w-4xl px-6 text-center">
          ...
          >
            ...
            <h2 className="font-display font-bold text-3xl sm:text-4xl lg:text-5xl text-gray-900 mb-6 tracking-tight leading-tight">
